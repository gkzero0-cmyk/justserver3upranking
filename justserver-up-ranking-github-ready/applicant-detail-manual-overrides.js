(function (root, factory) {
  ...
  const DETAIL_OVERRIDES = Object.freeze({
    ...
    wzxc152: Object.freeze({ name: '지맘대로리나' }),
    leesanggo: Object.freeze({
      message: '휴가 와있는데 물ㄹ속에서 방수팩으로 급ㅂ하게 쓰고 있습니다ㅏ 이번에도 컨텐츠 ㅇ열어주심에 감사하며 잘 즐겨보겠습니다!!🔥',
      moveInFee: '입주비 동의!!'
    }),
    rkqheks1: Object.freeze({
      message: '안녕하세요!!! 그냥서버를 꼭 즐겨보고싶은 뉴걸입니다 ㅜㅜ 저번에는 아쉽게도 못 들어갔었는데 이번엔 꼭꼭 들어가서 빚갚아보고싶어요...🤍',
      moveInFee: '입주비 동의합니다!!'
    }),
    rlarlgus94: Object.freeze({
      message: '안녕하십니까. 그냥서버2 최장접속자 냥쿠미임미다..!!!! 이번에도 질펀하게 즐기겠읍니다!! 졸업 딱 대!',
      moveInFee: '입주비 동의'
    }),
